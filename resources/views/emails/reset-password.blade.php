...
<body>
  ...
  <table
    ...
    cellpadding="0"
    align="center"
    id="m_3650805734604971768email_table"
    style="border-collapse:collapse"
  >
    <tbody>
      <tr>
        <td
          id="m_3650805734604971768email_content"
        ...
        >
                  ...
                  >
                    <tbody>
                      <tr>
                        ...
                        <td
                          style="line-height:0px;width:400px;padding:0 0 15px 0"
                        >
                          <table
                            border="0"
                            cellspacing="0"
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        <td>
                                                          <a
                                                            href="{{$data['link']}}"
                                                            style="color:#3b5998;text-decoration:none;display:block;width:370px"
                                                            target="_blank"
                                                            ><table
                                                              border="0"
                                                              width="390"
                                                                    ...
                                                                    <a
                                                                      ...
                                                                      ><center>
                                                                        <font
                                                                          size="3"
                                                                          ><span
                                                                            style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;white-space:nowrap;font-weight:bold;vertical-align:middle;color:#fdfdfd;font-size:16px;line-height:16px"
                                                                            >Log&nbsp;in&nbsp;as&nbsp;{{$data['username']}}</span
                                                                          ></font
                                                                        >
                                                                      </center></a
                                                                    >
                                                  ...
                                                  >
                                                    <tbody>
                                                      <tr>
                                                        <td></td>
                                                        <td
                                                          style="padding:0;margin:10px 0 10px 0;color:#565a5c;font-size:16px"
                                                        >
                                                        </td>
                                                      </tr>
                                                      <tr>
              ...
              <tr>
                <td>
                  ...
                  >
                    <tbody>
                      <tr>
                        <td height="5" style="line-height:5px" colspan="3">
                          &nbsp;
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div style="padding-top:10px">
                            <img
                              src="https://ci4.googleusercontent.com/proxy/1jVmGWy9tCnCqBWLSinJ6Z8m-mANhlu-0HJJpn3x1Rf1YzMg3CCnm8YzpKQh29yaES9XHM9NySfBVkv1HDbly59FbBb3QtlImd0tFZxpVA=s0-d-e1-ft#https://static.xx.fbcdn.net/rsrc.php/v3/yP/r/ARZq-vP6uSX.png"
                              height="30"
                              width="77"
                              alt=""
                              class="CToWUd"
                          ...
                          >
                            ...
                            <a style="color:#abadae;text-decoration:underline"
                              >{{$data['email']}}</a>
                            and intended for {{$data['username']}}.
                          </div>
                        </td>
                        <td width="20" style="display:block;width:20px">
                          &nbsp;&nbsp;&nbsp;
          ...
          <span
            ><img
              src="https://ci4.googleusercontent.com/proxy/i0XP_wUQ_IZh-blnwwj33InunfeCx0IAtTHg0HQ6dtmVUSp7dE5Q74Fkq5Kih05NUikS6JN62XgMEzyEU0NQFrjj1sqVsOZzwZbV1TeFDefsdhbzLLNnCnBxs8rTPHitP8z8Swj7TDxnfKx41A7GSKbW0rKr=s0-d-e1-ft#https://www.facebook.com/email_open_log_pic.php?mid=5b7e1bb881055G24bc2e3ae4189dG5b7e2051e1327G3df"
